...
SAMPLE_SPREADSHEET_ID = "1CiMd6hzzS7bRPfmMQ6QNSspBJwZFCqPlf5-DAUsfvsU"
SAMPLE_RANGE_NAME = "Respostas ao formulário 1!B:E"
...
def main():
    ...
    try:
        ...
        # print("Fetched values from spreadsheet")

        if not values:
            # print("No data found.")
            return

        # print("Values fetched:", values)
